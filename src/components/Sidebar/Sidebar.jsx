...
export const Sidebar = () => {
  ...
  const [submenus, setSubmenus] = useState([
    { name: 'Add Clinical', isOpen: false, options: [{ icon: <PiClockCountdown />, label: 'Appointments', selected: false }, { icon: <PiNotepad />, label: 'Tasks', selected: false }] },
    { name: 'Tasks', isOpen: false, options: [] },
  ]);
